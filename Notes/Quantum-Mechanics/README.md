...
This folder contains my notes, courses, and exercises about quantum mechanics.

## Courses

- [Wave–particle duality](wave-particle-duality.md)
- [Particle momentum](particle-momentum.md)
- [Physical observables and measurement](observables-and-measurement.md)
